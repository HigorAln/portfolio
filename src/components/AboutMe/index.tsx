  ...
  return (
    ...
    >
      <div className="max-w-7xl relative w-full h-full flex">
        <m.h1
          className={`font-poppins tracking-widest text-[50px] sm:text-[80px] md:text-[100px] lg:text-[145px] 2xl:text-[220px] font-bold text-gray-100 dark:text-style-g-e6 absolute top-0 leading-[10rem] sm:right-0 z-0`}
          layout
          initial={{ x: 0 }}
        >
          About me
        ...
        <div className="w-full flex flex-col sm:flex-row h-full pt-28 sm:pt-24 lg:pt-28 2xl:pt-32 z-10">
          ...
          <span className="sm:w-3/5 h-full pt-10 sm:pt-0 flex flex-col items-center gap-8">
            <div className="max-w-[550px] w-full flex flex-col gap-8">
              <p className="text-base sm:text-xl font-poppins text-slate-700 dark:text-style-g-ed">
